...
class DishCategoryCreateTest < ActionDispatch::IntegrationTest
	...
	test 'invalid dish category information' do
		...
		assert_no_difference 'DishCategory.count' do
			post dish_categories_url, dish_category: { name: "", description: "", image: fixture_file_upload('test/fixtures/images/too-large.jpg','images/jpeg') }
		end
	...
	test 'valid dish category information' do
		...
		assert_difference 'DishCategory.count', 1 do
			post dish_categories_url, dish_category: { name: "valid_name", description: "optional", image: fixture_file_upload('test/fixtures/images/salad.jpg','images/jpeg') }
		end
