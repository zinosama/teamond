...
class DishCategoryCreateTest < ActionDispatch::IntegrationTest
	...
	test 'valid dish category information' do
		...
		assert_select 'a.orange.ui.tag.label', text: "Taichi Milktea", count: 1
		...
		assert_select 'a.ui.red.tag.label[href=?]', edit_dish_category_url(dish_category), text: "valid_name", count: 1
	end
